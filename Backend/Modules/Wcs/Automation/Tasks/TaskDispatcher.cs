...
public class TaskDispatcher
{
        ...
        bool running, bool halted, InventoryCoordinator invCoord)
    {
        ...
        var stations = range.ApplyTo(allStations);
        ...
        lock (_chainLock)
        {
            ...
            if (startIsStorage)
            {
                ...
                var allowChainStart = startSource == AutoStartSources.PreviousTaskEnd;
        ...
        ctx.InventoryClaimCommitted = true;
    ...
    public class ExecCtx
    {
        ...
        public bool InventoryClaimCommitted { get; set; }
    }
}
